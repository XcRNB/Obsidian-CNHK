...
local SaveManager = {} do
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        local section = tab:AddRightGroupbox("功能配置")

        section:AddInput("SaveManager_ConfigName",    { Text = "配置名称" })
        section:AddButton("添加配置", function()
        ...
        section:AddButton("设置为自动加载", function()
            ...
            SaveManager.AutoloadLabel:SetText("删除自动加载配置: " .. name)
            self.Library:Notify(string.format("Set %q to auto load", name))
        end)
        section:AddButton("删除自动加载", function()
        ...
        self.AutoloadLabel = section:AddLabel("当前自动加载配置为: " .. self:GetAutoloadConfig(), true)
